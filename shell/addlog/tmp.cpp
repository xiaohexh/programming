...
void CheckPhoneMachine::Dump(int iFD) {
	DEBUG("==========void CheckPhoneMachine::Dump(int iFD) {=========");
}

int CheckPhoneMachine::Timeout(bool bMachineTimeout) {
	DEBUG("==========int CheckPhoneMachine::Timeout(bool bMachineTimeout) {=========");
    return 100;
}

int CheckPhoneMachine::StateMachineType() {
	DEBUG("==========int CheckPhoneMachine::StateMachineType() {=========");
    return MYID;
}

int CheckPhoneMachine::Entry_Init(InternalHead_t *pHead, void *pMessage) {
	DEBUG("==========int CheckPhoneMachine::Entry_Init(InternalHead_t *pHead, void *pMessage) {=========");
...
int CheckPhoneMachine::GetUserInfo() {
	DEBUG("==========int CheckPhoneMachine::GetUserInfo() {=========");
    UMessage sReqMsg;
...
int CheckPhoneMachine::Entry_GetUserInfo(InternalHead_t *pHead, void *pMessage) {
	DEBUG("==========int CheckPhoneMachine::Entry_GetUserInfo(InternalHead_t *pHead, void *pMessage) {=========");
    auto_ptr<UMessage> pRequest((UMessage*)pMessage);
